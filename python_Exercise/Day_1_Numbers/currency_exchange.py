...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    budget_converted = exchange_money(budget , new_exchange_rate)
    bills_number = get_number_of_bills(budget_converted , denomination)
    return get_value_of_bills(bills_number , denomination)
